...
part of 'coffeemachine_state_mgmt.dart';
...
mixin _$CoffeemachineState {
  ...
  double? get varD => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      machineOnline: null == machineOnline
          ...
          : machineOnline // ignore: cast_nullable_to_non_nullable
              as bool,
      isErrorState: null == isErrorState
          ? _value.isErrorState
      ...
      currentTemperature: freezed == currentTemperature
          ...
          : currentTemperature // ignore: cast_nullable_to_non_nullable
              as double?,
      targetTemperature: freezed == targetTemperature
          ? _value.targetTemperature
          : targetTemperature // ignore: cast_nullable_to_non_nullable
              as double?,
      varP: freezed == varP
          ? _value.varP
          : varP // ignore: cast_nullable_to_non_nullable
              as double?,
      varD: freezed == varD
          ? _value.varD
          : varD // ignore: cast_nullable_to_non_nullable
              as double?,
      varI: freezed == varI
          ? _value.varI
          : varI // ignore: cast_nullable_to_non_nullable
              as double?,
    ) as $Val);
  }
}
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.varP, varP) || other.varP == varP) &&
            (identical(other.varD, varD) || other.varD == varD) &&
            (identical(other.varI, varI) || other.varI == varI));
  }
